 ...
 */
bool om_decoder_decode_chunks(const OmDecoder_t *decoder, OmRange_t chunkIndex, const uint8_t* data, uint64_t dataCount, uint8_t* into, uint8_t* chunkBuffer, OmError_t* error);
